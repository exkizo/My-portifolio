      ...
      <div className="container px-5 py-10 mx-auto text-center">
        ...
        <div className="flex flex-wrap m-4">
          {education.map((education) => (
            <div class="m-4 max-w-md mx-auto max-h-full bg-gray-800 rounded-xl shadow-md overflow-hidden md:max-w-2xl">
              <div class="md:flex">
                <div class="md:flex-shrink-0">
                  <img className="object-cover w-full lg:object-contain bg-white md:h-full w-auto" src={education.image} alt="Education Logo"></img>
                </div>
                <div class="p-8">
